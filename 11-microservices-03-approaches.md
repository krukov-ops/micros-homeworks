# Домашнее задание к занятию «Микросервисы: подходы» Крюков Николай Сергеевич
...
- Сбор метрик со всех хостов: Prometheus использует pull-модель, собирая метрики с агентов, развернутых на каждом хосте (например, node_exporter для хостов ).
